<div class="max-w-xs bg-slate-300 border-2 rounded-lg shadow-m grid justify-items-center">
        <a href="#">
            <img class="p-6 rounded-t-md" src="https://imgs.search.brave.com/yzP2PCY4IWBzL8ZvePu-b3C2nvT4KTcV-Qnv0diYgRI/rs:fit:1200:1200:1/g:ce/aHR0cHM6Ly9pLnBp/bmltZy5jb20vb3Jp/Z2luYWxzL2U3LzEz/LzYwL2U3MTM2MDVl/OGYyMzNiMzFiNzJm/Y2YzZWNkNzQxMDgy/LmpwZw" alt="product image">
        </a>
    <div class="px-5 pb-2 rounded-md bg-slate-500">
        <a href="#">
